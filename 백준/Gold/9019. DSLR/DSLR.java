...
//                System.out.print(tem.num);
//                System.out.println(" "+tem.str);

                // 명령어 D S L R 한 값들을 queue 에 저장
...
//                queue.add(new Number(command_d(root.num),root.str + "D"));
//                queue.add(new Number(command_s(root.num),root.str + "S"));
//                queue.add(new Number(command_l(root.num),root.str + "L"));
//                queue.add(new Number(command_r(root.num),root.str + "R"));
